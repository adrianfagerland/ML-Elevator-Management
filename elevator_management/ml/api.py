...
class ElevatorEnvironment(gym.Env):
    ...
    def reset(self, seed=None, options={"density": 1}):
        ...
        if self.observation_type == "dict":
            ...
            self.observation_feature_extr = ObservationFeatureExtractor(
        ...
        if self.action_type == "dict":
            ...
            self.action_feature_extractor = ActionFeatureExtractor(
                action_space_dict, num_floors=self.num_floors, max_elevators=self.num_elevators_range[1] - 1
            )
